document.addEventListener("DOMContentLoaded", function () {
    ...
    function hash(text) {
         ...
         const K = [
             ...
             0x1e376c08, 0x3c6ef372, 0x4f67c38e, 0x5b9cca4f, 0x682e6ff3, 0x748f82ee, 0x78a5636f, 0x84c87814,
    ...
    // Create Merkle Root function
    function createMerkleRoot(transactions) {
        let merkleLayer = transactions.map(tx => hash(tx));
    ...
    class Block {
        ...
        mineBlock() {
            this.merkleRoot = createMerkleRoot(this.transactions);
            const blockData = this.previousHash + this.timestamp + this.merkleRoot;
            this.hash = hash(blockData);
        }
    }
    ...
    class Blockchain {
        ...
        validateBlockchain() {
            for (let i = 1; i < this.chain.length; i++) {
                ...
                const validHash = hash(blockData);
    ...
    document.getElementById("mineBlock").addEventListener("click", () => {
        ...
        blockchain.addTransaction("Askar", "Ayazhan", 25);
        blockchain.addTransaction("Ayazhan", "Nurilya", 30);
        blockchain.addTransaction("Nurilya", "Aida", 35);
        blockchain.addTransaction("Aida", "Ruslan", 40);
        blockchain.addTransaction("Ruslan", "Zhansaya", 45);
